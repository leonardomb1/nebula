 ...
 * Holds a PKCE verifier and CSRF state, lives ten minutes, and is deleted the
 * moment the callback runs — it cannot authorise anything on its own.
 *
 ...
 */
export const FLOW_COOKIE = 'nebula_oidc';
